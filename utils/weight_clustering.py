...
def concat_raw_vec(perm_to_axes, params, p_name, n):
  A = None
...
def concat_raw_vec_d(perm_to_axes, params, p_name, n):
  A = None
  for wk, axis in perm_to_axes[p_name]:
    w_a = params[wk]
...
def merge_channel_approx_repair(perm_to_axes, params, p_name, merge):
    params = copy.deepcopy(params)
    n = params[perm_to_axes[p_name][0][0]].shape[perm_to_axes[p_name][0][1]]
    w = concat_raw_vec_d(perm_to_axes, params, p_name, n)
...
def self_merge_weight_clustering(perm_to_axes, params, max_ratio=0.5, threshold=0.1, hooks=None, approx_repair=False):
    ...
    for p_name in merge_sizes.keys():
        ...
        if hooks is not None:
            ...
            distance = concat_raw_vec(perm_to_axes, params, p_name, n)
    ...
    for p_name in merge_sizes.keys():
        ...
        if approx_repair is False:
            ...
            prm = merge_channel_approx_repair(perm_to_axes, params, p_name, merge)
