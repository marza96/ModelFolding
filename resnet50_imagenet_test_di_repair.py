...
from model.resnet import merge_channel_ResNet50_big_clustering
...
def main():
    ...
    load_model(model, "/home/m/marza1/Iterative-Feature-Merging/resnet50_imagenet.pt", override=False)

    ratio = 0.1
    new_model, acc, sparsity = test_merge(copy.deepcopy(model), copy.deepcopy(model).state_dict(), test_loader, train_loader, ratio, 100.0, "figure_path", merge_channel_ResNet50_big_clustering, eval=True)
    print("ACCURACY", acc)
