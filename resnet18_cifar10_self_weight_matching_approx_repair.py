...
def main():
    ...
    new_model, _, _ = test_merge(copy.deepcopy(model), copy.deepcopy(model).state_dict(), test_loader, train_loader, 0.45, threshold, figure_path, merge_channel_ResNet18_clustering_approx_repair, eval=True)
